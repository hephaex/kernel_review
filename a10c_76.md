...
## io.h::ioremap()
* start_kernel()->init_IRQ()->gic_of_init()->of_iomap()->ioremap()
...
* start_kernel()->init_IRQ()->gic_of_init()->of_iomap()->ioremap()->__arm_ioremap()
...
* start_kernel()->init_IRQ()->gic_of_init()->of_iomap()->ioremap()->__arm_ioremap()->__arm_ioremap_caller()->__arm_ioremap_pfn_caller()

...
* ᇂ150차 시작 위치
  ...
  - sysctl_init      2288  return sysctl_init();
  - register_sysctl_table  1696  ~/kernel/sysctl.c
  - register_sysctl_paths  2130  return register_sysctl_paths(null_path, table);
  - __register_sysctl_paths  2109  return __register_sysctl_paths(&sysctl_table_root.default_set,
  - register_leaf_sysctl_tables  2072  if (register_leaf_sysctl_tables(new_path, pos, &subheader,
  - __register_sysctl_table  1921  header = __register_sysctl_table(set, path, files);

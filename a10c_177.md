...
* 177 주차시작 위치
  ...
  - rest_init        1914  ~/init/main.c
  - kernel_thread    1401  ~/init/main.c
  - do_fork          4655  return do_fork(flags|CLONE_VM|CLONE_UNTRACED, (unsigned long)fn,
  - copy_process     3642  p = copy_process(clone_flags, stack_start, stack_size,
1  1 start_kernel        1  ~/kernel/iamroot/linux-stable/init/main.c
  2  1 rest_init        1914  ~/kernel/iamroot/linux-stable/init/main.c
  3  1 kernel_thread    1401  ~/kernel/iamroot/linux-stable/init/main.c
  4  1 do_fork          5342  ~/kernel/iamroot/linux-stable/kernel/fork.c
  5  1 wake_up_new_task  5217  ~/kernel/iamroot/linux-stable/kernel/fork.c
  6  1 activate_task    2516  ~/kernel/iamroot/linux-stable/kernel/sched/core.c
  7  1 enqueue_task     1016  ~/kernel/iamroot/linux-stable/kernel/sched/core.c
  8  1 enqueue_task_fair   922  ~/kernel/iamroot/linux-stable/kernel/sched/core.c
  9  1 enqueue_entity   4575  enqueue_entity(cfs_rq, se, flags);
...
## log
```
d159c7d5aeeb..d6ae43bd1355  master     -> origin/master
Updating d159c7d5aeeb..d6ae43bd1355
Fast-forward

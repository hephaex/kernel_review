...
* 177 주차시작 위치
  ...
  - do_fork           5342  ~/kernel/iamroot/linux-stable/kernel/fork.c
  - wake_up_new_task  5217  ~/kernel/fork.c
  - activate_task    2516  ~/kernel/sched/core.c
  - enqueue_task     1016  ~/kernel/sched/core.c
  - enqueue_task_fair   922  ~/kernel/sched/core.c
  - enqueue_entity   4575  enqueue_entity(cfs_rq, se, flags);
...
## log
```
d6ae43bd1355..4e061decff45  master     -> origin/master
Updating d6ae43bd1355..4e061decff45
Fast-forward
 ...
 lib/rbtree.c             |   3 +
 15 files changed, 1359 insertions(+), 16 deletions(-)
```

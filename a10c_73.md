...
From github.com:arm10c/linux-stable
   f06fef9..7ff1392  master     -> origin/master
Updating f06fef9..7ff1392
Fast-forward
drivers/of/base.c                            | 19 +++++++++++++++++++
drivers/of/irq.c                             | 47 +++++++++++++++++++++++++++++++++++------------
include/linux/byteorder/generic.h            |  1 +
...
```c
From github.com:arm10c/linux-stable
   7ff1392..34fb6b2  master     -> origin/master
Updating 7ff1392..34fb6b2
Fast-forward
Reference/petazzoni-device-tree-dummies.pdf | Bin 0 -> 1165365 bytes
...
create mode 100644 Reference/petazzoni-device-tree-dummies.pdf```
```
